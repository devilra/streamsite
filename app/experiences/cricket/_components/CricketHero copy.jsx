...
// ---------------------------------------------------------------------------
// Team avatar: shows the team image when available, otherwise falls back to
// the team's first initial using the existing dark/slate + lime theme.
// No new visual language — same border, same rounded treatment as the rest
// of the card.
// ---------------------------------------------------------------------------
